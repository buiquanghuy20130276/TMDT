...
const ProductManagement = () => {
    ...
    useEffect(() => {
        axios.get(`${baseUrl}/products/getAll`).then(res => {
    ...
    const deleteMultipleProducts = async () => {
        try {
            const response = await axios.delete('http://localhost:8080/api/v1/management/product/delete/products', {
                data: {
    ...
    const handleImportProduct = async (event) => {
        ...
        try {
            await axios.post('http://localhost:8080/api/v1/management/product/import', formData, {
                headers: {
