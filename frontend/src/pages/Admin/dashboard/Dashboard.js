...
const Dashboard = () => {
    ...
    useEffect(() => {
        const fetchYear = async () => {
            try {
                const res = await axios.get("http://localhost:8080/api/v1/management/dashboard/get-years", {
                    headers: {
    ...
    useEffect(() => {
        const fetchMonth = async () => {
            try {
                if (yearPie) {
                    const res = await axios.get(`http://localhost:8080/api/v1/management/dashboard/get-months/${yearPie}`, {
                        headers: {
                            Authorization: `Bearer ${accessToken}`,
                        },
                    });
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axios.get("http://localhost:8080/api/v1/management/dashboard/total-revenue", {
                    params: { year: year },
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                    },
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axios.get("http://localhost:8080/api/v1/management/dashboard/count-order-in-year", {
                    params: { year: year },
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                    },
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axios.get("http://localhost:8080/api/v1/management/dashboard/count-user", {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                    },
                });
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const res = await axios.get("http://localhost:8080/api/v1/management/dashboard/sold-by-category", {
                    params: {
                        month: monthPie,
                        year: yearPie
                    },
        ...
        const fetchData = async () => {
            try {
                const requests = monthsAreaChart.map(month =>
                    axios.get("http://localhost:8080/api/v1/management/dashboard/quatity-order-by-month-year", {
                        params: {
                            month,
                            year
                        },
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const res = await axios.get("http://localhost:8080/api/v1/management/dashboard/best-selling-products", {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                    },
                });
    ...
    useEffect(() => {
        const fetchUser = async () => {
            try {
                const res = await axios.get("http://localhost:8080/api/v1/management/dashboard/top-user-selling", {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                    },
                });
