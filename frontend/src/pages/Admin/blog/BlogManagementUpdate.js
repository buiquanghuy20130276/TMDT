...
export default function BlogManagementUpdate(){
    ...
    const updateBlog=async(event)=>{
        ...
        if (blog.title !== '' && blog.description !== '' && blog.author !== '' && blog.content !== '' && blog.category !== '' && blog.img !== '' ) {
            ...
            console.log(data)
            await axios.put(`http://localhost:8080/api/v1/blogs/update/${id}`, data
            ).then(res => {
            ...
            <div>
                ...
                <Form onSubmit={''}>
                    ...
                    <Container className="text-center">
                        <Button type="submit" className="rounded-0" color="primary" onClick={updateBlog}>Chỉnh sửa</Button>
