...
import ProductManagementUpdate from "../product/ProductManagementUpdate";
...
function BlogManagement(){
    ...
    const deleteMultipleBlogs = async () => {
        try {
            const response = await axios.delete('http://localhost:8080/api/v1/blogs/deletes', {
                data: {
    ...
    const handleImportBlogs = async (event) => {
        ...
        try {
            await axios.post('http://localhost:8080/api/v1/blogs/import', formData, {
                headers: {
