              ...
              <ul className="nav navbar-nav float-right be-user-nav">
                <li className="nav-item dropdown">
                  ...
                  <div className="dropdown-menu" role="menu">
                    ...
                    <Link className="dropdown-item" to="/logout"><span className="icon mdi mdi-power"></span>Đăng xuất</Link>
                  </div>
                </li>
              </ul>
              ...
              <div className="left-sidebar-scroll">
                <div className="left-sidebar-content">
                  <ul className="sidebar-elements">
                    ...
                    <li>
                      <Link to="/feedback"><i className="icon mdi mdi-account-box-mail"></i><span>Phản hồi</span></Link>
                    </li>
                    {/* Other menu items */}
                  </ul>
                </div>
